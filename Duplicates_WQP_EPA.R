...
not.usgs$Temp.wqp.epa.id<-paste('temp_wqp_epa_id', seq(1,nrow(not.usgs)), sep="_")
...
#remove duplicates
wqp.dup.data$unique.id<-gsub("\\s", "", paste(wqp.dup.data[['MonitoringLocationIdentifier']], wqp.dup.data[['unique.meas.id']], sep="_"))
